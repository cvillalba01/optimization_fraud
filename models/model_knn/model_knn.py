...
# Crear el modelo KNN
model = KNeighborsClassifier(n_neighbors=50)  # Puedes ajustar n_neighbors según sea necesario
...
plt.savefig('/home/avelazquez/projects/fraud-detection-pry/models/model_knn/confusion_matrix.png')
...
plt.title('Curva ROC')
plt.savefig('/home/avelazquez/projects/fraud-detection-pry/models/model_knn/roc_curve.png')
...
plt.savefig('/home/avelazquez/projects/fraud-detection-pry/models/model_knn/metrics_bar_chart.png')
