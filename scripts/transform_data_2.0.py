...
merged_data['application_id'] = merged_data['application_id'].astype(str)

# Reemplazar valores 'nan' como string por '0' y manejar valores NaN reales
merged_data['application_id'] = merged_data['application_id'].replace(['nan', '0.0', '10.0', '9.0', '15.0'], ['0', '0', '10', '9', '15']).fillna('0')
...
# Realizar el merge con la nueva planilla
merged_data = pd.merge(merged_data, new_data, on='rrn', how='left')
